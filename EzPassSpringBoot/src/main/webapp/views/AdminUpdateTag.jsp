...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id ="content-wrapper">
                ...
                <main> 
                    ...
                    <form name="UpdateTag" action="${pageContext.request.contextPath}/Admin/UpdateCustomerEzTag" method="post">
        ...
        <script>
            ...
            {
                TagCode = document.UpdateTag.TagCode.value;
                NewTagType = document.UpdateTag.NewTagType.value;
                if(TagCode == "" || NewTagType == ""){
                    window.alert("TagCode and New Tag Type must not be empty!");
                }
                else{
